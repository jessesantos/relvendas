            ...
            <div class="col-lg-12">
                ...
                <form method="post" action="{{ route('vendas.update', $venda->id) }}">
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" value="{{ $venda->quantidade }}" class="form-control" id="quantidade" name="quantidade" placeholder="Quantidade em estoque" required>
                    </div>
                    <div class="form-group">
                        <label for="valor">Valor *</label>
                        <input type="text" value="{{ $venda->valor }}" class="form-control" id="valor" name="valor" placeholder="Exemplo: 1099.99" required>
                    </div>
