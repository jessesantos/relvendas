...
<script src="http://{{ $_SERVER['HTTP_HOST'] }}/assets/demo/chart-area-demo.js"></script>
<script src="http://{{ $_SERVER['HTTP_HOST'] }}/assets/demo/chart-bar-demo.js"></script>
<script src="https://cdn.datatables.net/1.10.20/js/jquery.dataTables.min.js" crossorigin="anonymous"></script>
<script src="https://cdn.datatables.net/1.10.20/js/dataTables.bootstrap4.min.js" crossorigin="anonymous"></script>
<script src="http://{{ $_SERVER['HTTP_HOST'] }}/assets/demo/datatables-demo.js"></script>
</body>
</html>
